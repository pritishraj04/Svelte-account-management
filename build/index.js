...
var require_lib = __commonJS({
  "node_modules/node-fetch/lib/index.js"(exports, module) {
    ...
    function convertBody(buffer2, headers) {
      ...
      if (res) {
        charset3 = res.pop();
        if (charset3 === "gb2312" || charset3 === "gbk") {
          charset3 = "gb18030";
        }
      }
      return convert(buffer2, "UTF-8", charset3).toString();
    }
    ...
    function fetch3(url, opts) {
      ...
      return new fetch3.Promise(function(resolve3, reject) {
        ...
        const send2 = (options2.protocol === "https:" ? https2 : http2).request;
        ...
        return new Promise((resolve3, reject) => {
          cross_fetch_1.default(url, _getRequestParams(method, options2, body)).then((result) => {
            ...
            if (options2 === null || options2 === void 0 ? void 0 : options2.noResolveJson)
              return resolve3;
            return result.json();
          }).then((data) => resolve3(data)).catch((error3) => handleError(error3, reject));
        });
      });
    }
  ...
  "node_modules/@supabase/realtime-js/dist/main/lib/transformers.js"(exports) {
    ...
    exports.convertColumn = (columnName, columns, records, skipTypes) => {
      ...
      if (!column || skipTypes.includes(column.type)) {
        return noop4(records[columnName]);
      } else {
  ...
  "node_modules/@supabase/realtime-js/dist/main/RealtimeSubscription.js"(exports) {
    ...
    var RealtimeSubscription = class {
      ...
      trigger(event, payload, ref) {
        let { close, error: error3, leave, join: join2 } = constants_1.CHANNEL_EVENTS;
        let events = [close, error3, leave, join2];
...
var require_ms = __commonJS({
  "node_modules/websocket/node_modules/ms/index.js"(exports, module) {
    ...
    function fmtLong2(ms2) {
      return plural2(ms2, d2, "day") || plural2(ms2, h2, "hour") || plural2(ms2, m2, "minute") || plural2(ms2, s3, "second") || ms2 + " ms";
    }
  ...
  "node_modules/websocket/node_modules/debug/src/node.js"(exports, module) {
    ...
    function createWritableStdioStream(fd2) {
      ...
      switch (tty_wrap.guessHandleType(fd2)) {
        case "TTY":
          stream2 = new tty2.WriteStream(fd2);
          stream2._type = "tty";
...
var require_utils = __commonJS({
  "node_modules/websocket/lib/utils.js"(exports) {
    ...
    exports.bufferFromString = Buffer.from ? Buffer.from : function oldBufferFromString(string, encoding3) {
      return new Buffer(string, encoding3);
    };
...
var require_FastBufferList = __commonJS({
  "node_modules/websocket/vendor/FastBufferList.js"(exports, module) {
    ...
    function BufferList(opts) {
      ...
      self2.take = function(n, encoding3) {
        if (n == void 0)
          n = self2.length;
        ...
        var b = head;
        if (!encoding3)
          encoding3 = self2.encoding;
        if (encoding3) {
          var acc = "";
          self2.forEach(function(buffer2) {
            if (n <= 0)
              return true;
            acc += buffer2.toString(encoding3, 0, Math.min(n, buffer2.length));
            n -= buffer2.length;
          });
          return acc;
        } else {
...
var require_WebSocketConnection = __commonJS({
  "node_modules/websocket/lib/WebSocketConnection.js"(exports, module) {
    ...
    util2.inherits(WebSocketConnection, EventEmitter);
...
var require_WebSocketRequest = __commonJS({
  "node_modules/websocket/lib/WebSocketRequest.js"(exports, module) {
    ...
    util2.inherits(WebSocketRequest, EventEmitter);
...
var require_WebSocketServer = __commonJS({
  "node_modules/websocket/lib/WebSocketServer.js"(exports, module) {
    ...
    var utils = require_utils();
    var util2 = __require("util");
    var debug2 = require_src()("websocket:server");
    var EventEmitter = __require("events").EventEmitter;
    ...
    util2.inherits(WebSocketServer, EventEmitter);
...
var require_WebSocketClient = __commonJS({
  "node_modules/websocket/lib/WebSocketClient.js"(exports, module) {
    ...
    util2.inherits(WebSocketClient, EventEmitter);
...
var require_WebSocketRouterRequest = __commonJS({
  "node_modules/websocket/lib/WebSocketRouterRequest.js"(exports, module) {
    ...
    util2.inherits(WebSocketRouterRequest, EventEmitter);
...
var require_WebSocketRouter = __commonJS({
  "node_modules/websocket/lib/WebSocketRouter.js"(exports, module) {
    ...
    util2.inherits(WebSocketRouter, EventEmitter);
...
var require_W3CWebSocket = __commonJS({
  "node_modules/websocket/lib/W3CWebSocket.js"(exports, module) {
    ...
    var toBuffer2 = require_typedarray_to_buffer();
...
var require_package = __commonJS({
  "node_modules/websocket/package.json"(exports, module) {
    module.exports = {
      ...
      _where: "C:\\E\\Others\\Project\\Svelte\\scrachApp\\node_modules\\@supabase\\realtime-js",
      author: {
        name: "Brian McKelvey",
      ...
      disconnect(code, reason) {
        return new Promise((resolve3, _reject) => {
          try {
            ...
            resolve3({ error: null, data: true });
          } catch (error3) {
            resolve3({ error: error3, data: false });
          }
        });
      }
      log(kind, msg, data) {
  ...
  "node_modules/@supabase/storage-js/dist/main/lib/StorageFileApi.js"(exports) {
    ...
    var StorageFileApi = class {
      ...
      remove(paths2) {
        return __awaiter(this, void 0, void 0, function* () {
          try {
            const data = yield fetch_1.remove(`${this.url}/object/${this.bucketId}`, { prefixes: paths2 }, { headers: this.headers });
            return { data, error: null };
          } catch (error3) {
            return { data: null, error: error3 };
          }
        ...
        return new Promise((resolve3) => __awaiter(this, void 0, void 0, function* () {
          try {
            ...
            if (!openSubscriptions) {
              ...
              if (error3)
                return resolve3({ error: error3 });
            }
            return resolve3({ error: null, data: { openSubscriptions } });
          } catch (error3) {
            return resolve3({ error: error3 });
          }
        }));
...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-af1739f2.js",
      css: ["/./_app/assets/start-0826e215.css"],
      js: ["/./_app/start-af1739f2.js", "/./_app/chunks/vendor-e40e4385.js", "/./_app/chunks/singletons-bb9012b7.js"]
    },
    fetched: void 0,
    floc: false,
...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "assets/imgs/shoe.png", "size": 143717, "type": "image/png" }, { "file": "favicon.png", "size": 1571, "type": "image/png" }, { "file": "robots.txt", "size": 67, "type": "text/plain" }, { "file": "svelte-welcome.png", "size": 360807, "type": "image/png" }, { "file": "svelte-welcome.webp", "size": 115470, "type": "image/webp" }],
  ...
  routes: [
    ...
    },
    {
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/profile/update.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
...
var module_lookup = {
  ...
  "src/routes/profile/update.svelte": () => Promise.resolve().then(function() {
    return update;
  }),
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-77ad0e0a.js", "css": ["/./_app/assets/pages/__layout.svelte-9f426ade.css"], "js": ["/./_app/pages/__layout.svelte-77ad0e0a.js", "/./_app/chunks/vendor-e40e4385.js", "/./_app/chunks/stores-8451b46e.js", "/./_app/chunks/db-7bf1fdc8.js"], "styles": null }, ".svelte-kit/build/components/error.svelte": { "entry": "/./_app/error.svelte-9fe36427.js", "css": [], "js": ["/./_app/error.svelte-9fe36427.js", "/./_app/chunks/vendor-e40e4385.js"], "styles": null }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-3f600e4e.js", "css": ["/./_app/assets/pages/index.svelte-c608b461.css"], "js": ["/./_app/pages/index.svelte-3f600e4e.js", "/./_app/chunks/vendor-e40e4385.js", "/./_app/chunks/stores-8451b46e.js"], "styles": null }, "src/routes/products/index.svelte": { "entry": "/./_app/pages/products/index.svelte-9dad3af6.js", "css": ["/./_app/assets/pages/products/index.svelte-57513c67.css"], "js": ["/./_app/pages/products/index.svelte-9dad3af6.js", "/./_app/chunks/vendor-e40e4385.js"], "styles": null }, "src/routes/profile/index.svelte": { "entry": "/./_app/pages/profile/index.svelte-c8e6be4b.js", "css": ["/./_app/assets/pages/profile/index.svelte-082163e0.css", "/./_app/assets/ATag-5d6f39c1.css"], "js": ["/./_app/pages/profile/index.svelte-c8e6be4b.js", "/./_app/chunks/vendor-e40e4385.js", "/./_app/chunks/stores-8451b46e.js", "/./_app/chunks/ATag-09bfc668.js", "/./_app/chunks/db-7bf1fdc8.js"], "styles": null }, "src/routes/profile/update.svelte": { "entry": "/./_app/pages/profile/update.svelte-da06ea40.js", "css": ["/./_app/assets/ATag-5d6f39c1.css", "/./_app/assets/navigation-944200cb.css"], "js": ["/./_app/pages/profile/update.svelte-da06ea40.js", "/./_app/chunks/vendor-e40e4385.js", "/./_app/chunks/ATag-09bfc668.js", "/./_app/chunks/navigation-75ff378a.js", "/./_app/chunks/singletons-bb9012b7.js", "/./_app/chunks/db-7bf1fdc8.js"], "styles": null }, "src/routes/signin.svelte": { "entry": "/./_app/pages/signin.svelte-a71d93a6.js", "css": ["/./_app/assets/pages/signin.svelte-8970bead.css", "/./_app/assets/navigation-944200cb.css"], "js": ["/./_app/pages/signin.svelte-a71d93a6.js", "/./_app/chunks/vendor-e40e4385.js", "/./_app/chunks/navigation-75ff378a.js", "/./_app/chunks/singletons-bb9012b7.js", "/./_app/chunks/Icon-088eb577.js", "/./_app/chunks/db-7bf1fdc8.js", "/./_app/chunks/stores-8451b46e.js"], "styles": null }, "src/routes/signup.svelte": { "entry": "/./_app/pages/signup.svelte-85bf208e.js", "css": ["/./_app/assets/pages/signin.svelte-8970bead.css", "/./_app/assets/navigation-944200cb.css"], "js": ["/./_app/pages/signup.svelte-85bf208e.js", "/./_app/chunks/vendor-e40e4385.js", "/./_app/chunks/navigation-75ff378a.js", "/./_app/chunks/singletons-bb9012b7.js", "/./_app/chunks/Icon-088eb577.js", "/./_app/chunks/db-7bf1fdc8.js", "/./_app/chunks/stores-8451b46e.js"], "styles": null } };
...
var supabase = (0, import_supabase_js.createClient)("https://swgmtbtxorxqriaxriyl.supabase.co", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlIjoiYW5vbiIsImlhdCI6MTYyMjYyODgzMiwiZXhwIjoxOTM4MjA0ODMyfQ._m5KD2iYa0FPINd7iFlLdFHdH15SEh5m00GBhlibfKw");
...
var Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <nav class="${"svelte-z0q9f3"}"><svg viewBox="${"0 0 2 3"}" aria-hidden="${"true"}" class="${"svelte-z0q9f3"}"><path d="${"M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z"}" class="${"svelte-z0q9f3"}"></path></svg>
    <ul class="${"svelte-z0q9f3"}"><li class="${["svelte-z0q9f3", $page.path === "/" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-z0q9f3"}">Home</a></li>
      ${$session === null ? `<li class="${["svelte-z0q9f3", $page.path === "/signup" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/signup"}" class="${"svelte-z0q9f3"}">Sign Up</a></li>
        <li class="${["svelte-z0q9f3", $page.path === "/signin" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/signin"}" class="${"svelte-z0q9f3"}">Sign In</a></li>` : `<li class="${["svelte-z0q9f3", $page.path === "/profile" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/profile"}" class="${"svelte-z0q9f3"}">Profile</a></li>
        <li class="${"svelte-z0q9f3"}"><a href="${"/"}" class="${"svelte-z0q9f3"}">Sign Out</a></li>`}</ul>
...
var css$9 = {
  code: "main.svelte-1waf613{box-sizing:border-box;margin:0 auto;padding:1rem 5rem;width:100%}",
  map: '{"version":3,"file":"__layout.svelte","sources":["__layout.svelte"],"sourcesContent":["<script>\\n  import { browser } from \\"$app/env\\";\\n\\n  import { session } from \\"$app/stores\\";\\n  import supabase from \\"$lib/db\\";\\n\\n  import Header from \\"$lib/Header/index.svelte\\";\\n  import \\"../app.css\\";\\n\\n  if (browser) {\\n    $session = supabase.auth.session();\\n    supabase.auth.onAuthStateChange((event, supaSession) => {\\n      $session = supaSession;\\n    });\\n  }\\n<\/script>\\n\\n<Header />\\n\\n<main>\\n  <slot />\\n</main>\\n\\n<style>main{box-sizing:border-box;margin:0 auto;padding:1rem 5rem;width:100%}</style>\\n"],"names":[],"mappings":"AAuBO,mBAAI,CAAC,WAAW,UAAU,CAAC,OAAO,CAAC,CAAC,IAAI,CAAC,QAAQ,IAAI,CAAC,IAAI,CAAC,MAAM,IAAI,CAAC"}'
};
...
<main class="${"svelte-1waf613"}">${slots.default ? slots.default({}) : ``}
</main>`;
});
...
var css$8 = {
  code: "section.svelte-14s68fu.svelte-14s68fu{align-items:center;display:flex;flex:1;flex-direction:column;justify-content:center}.welcome.svelte-14s68fu.svelte-14s68fu{height:0;padding:0 0 24.16992%;position:relative;width:100%}.welcome.svelte-14s68fu img.svelte-14s68fu{display:block;height:100%;position:absolute;top:0;width:100%}pre.svelte-14s68fu.svelte-14s68fu{overflow:scroll;width:25rem}",
  map: '{"version":3,"file":"index.svelte","sources":["index.svelte"],"sourcesContent":["<script context=\\"module\\">\\n  export const prerender = true;\\n<\/script>\\n\\n<script>\\n  import { session } from \\"$app/stores\\";\\n<\/script>\\n\\n<svelte:head>\\n  <title>Home</title>\\n</svelte:head>\\n\\n<section>\\n  <h1>\\n    <div class=\\"welcome\\">\\n      <picture>\\n        <source srcset=\\"svelte-welcome.webp\\" type=\\"image/webp\\" />\\n        <img src=\\"svelte-welcome.png\\" alt=\\"Welcome\\" />\\n      </picture>\\n    </div>\\n\\n    to your new<br />SvelteKit app\\n  </h1>\\n\\n  <h2>\\n    try editing <strong>src/routes/index.svelte</strong>\\n  </h2>\\n\\n  <pre>\\n      {JSON.stringify($session, null, 2)}\\n    </pre>\\n</section>\\n\\n<style style lang=\\"postcss\\">section{align-items:center;display:flex;flex:1;flex-direction:column;justify-content:center}.welcome{height:0;padding:0 0 24.16992%;position:relative;width:100%}.welcome img{display:block;height:100%;position:absolute;top:0;width:100%}pre{overflow:scroll;width:25rem}</style>\\n"],"names":[],"mappings":"AAiC4B,qCAAO,CAAC,YAAY,MAAM,CAAC,QAAQ,IAAI,CAAC,KAAK,CAAC,CAAC,eAAe,MAAM,CAAC,gBAAgB,MAAM,CAAC,sCAAQ,CAAC,OAAO,CAAC,CAAC,QAAQ,CAAC,CAAC,CAAC,CAAC,SAAS,CAAC,SAAS,QAAQ,CAAC,MAAM,IAAI,CAAC,uBAAQ,CAAC,kBAAG,CAAC,QAAQ,KAAK,CAAC,OAAO,IAAI,CAAC,SAAS,QAAQ,CAAC,IAAI,CAAC,CAAC,MAAM,IAAI,CAAC,iCAAG,CAAC,SAAS,MAAM,CAAC,MAAM,KAAK,CAAC"}'
};
var prerender = true;
...
<section class="${"svelte-14s68fu"}"><h1><div class="${"welcome svelte-14s68fu"}"><picture><source srcset="${"svelte-welcome.webp"}" type="${"image/webp"}">
        <img src="${"svelte-welcome.png"}" alt="${"Welcome"}" class="${"svelte-14s68fu"}"></picture></div>
  ...
  <pre class="${"svelte-14s68fu"}">${escape2(JSON.stringify($session, null, 2))}</pre>
</section>`;
});
...
var css$7 = {
  code: '@import url("https://fonts.googleapis.com/css?family=Muli");.card.svelte-1rocsq8.svelte-1rocsq8{border-radius:20px}.card.svelte-1rocsq8 .top.svelte-1rocsq8{align-items:center;background-color:#ff6d39;border-radius:0 0 50% 50%;content:"";display:flex;height:10em;position:absolute;width:14em;z-index:5}.card.svelte-1rocsq8 .top img.svelte-1rocsq8{margin-left:-3em;margin-top:60px;width:15em}.card.svelte-1rocsq8 .bottom.svelte-1rocsq8{background-color:#2a2f40;content:"";height:20em;width:14em;z-index:3}.card.svelte-1rocsq8 .bottom .details.svelte-1rocsq8{padding:10em 2em 2em}.card.svelte-1rocsq8 .bottom .details h1.svelte-1rocsq8{color:#ff6d39;font-family:muli;font-size:1em;font-weight:700}.card.svelte-1rocsq8 .bottom .details h3.svelte-1rocsq8{color:#fff;font-family:muli;font-size:.7em;font-weight:500}.card.svelte-1rocsq8 .bottom .details h6.svelte-1rocsq8{color:#fff;font-family:muli;font-size:1em;font-weight:700;margin:0}.card.svelte-1rocsq8 .bottom .action.svelte-1rocsq8{margin:0 auto}.card.svelte-1rocsq8 .bottom .action span.svelte-1rocsq8{padding:0 1em}.card.svelte-1rocsq8 .bottom .action span a.svelte-1rocsq8{color:#fff;text-decoration:none}.card.svelte-1rocsq8 .bottom .action span a i.svelte-1rocsq8{width:.3em}',
  map: '{"version":3,"file":"index.svelte","sources":["index.svelte"],"sourcesContent":["<script><\/script>\\r\\n\\r\\n<div class=\\"card\\">\\r\\n  <div class=\\"top\\">\\r\\n    <img src=\\"./assets/imgs/shoe.png\\" alt=\\"Shoe\\" />\\r\\n  </div>\\r\\n  <div class=\\"bottom\\">\\r\\n    <div class=\\"details\\">\\r\\n      <h1>Nike Pro Elite</h1>\\r\\n      <h3>Running Shoe Pro</h3>\\r\\n      <h6>$200</h6>\\r\\n    </div>\\r\\n    <div class=\\"action\\">\\r\\n      <span class=\\"buy\\"><a href=\\"\\"><i class=\\"icon-buy\\" /> Buy Now</a></span>\\r\\n      <span class=\\"cart\\"><a href=\\"\\"><i class=\\"icon-cart\\" />Add to cart</a></span\\r\\n      >\\r\\n    </div>\\r\\n  </div>\\r\\n</div>\\r\\n\\r\\n<style lang=\\"scss\\">@import url(\\"https://fonts.googleapis.com/css?family=Muli\\");.card{border-radius:20px}.card .top{align-items:center;background-color:#ff6d39;border-radius:0 0 50% 50%;content:\\"\\";display:flex;height:10em;position:absolute;width:14em;z-index:5}.card .top img{margin-left:-3em;margin-top:60px;width:15em}.card .bottom{background-color:#2a2f40;content:\\"\\";height:20em;width:14em;z-index:3}.card .bottom .details{padding:10em 2em 2em}.card .bottom .details h1{color:#ff6d39;font-family:muli;font-size:1em;font-weight:700}.card .bottom .details h3{color:#fff;font-family:muli;font-size:.7em;font-weight:500}.card .bottom .details h6{color:#fff;font-family:muli;font-size:1em;font-weight:700;margin:0}.card .bottom .action{margin:0 auto}.card .bottom .action span{padding:0 1em}.card .bottom .action span a{color:#fff;text-decoration:none}.card .bottom .action span a i{width:.3em}</style>\\r\\n"],"names":[],"mappings":"AAoBmB,QAAQ,IAAI,8CAA8C,CAAC,CAAC,mCAAK,CAAC,cAAc,IAAI,CAAC,oBAAK,CAAC,mBAAI,CAAC,YAAY,MAAM,CAAC,iBAAiB,OAAO,CAAC,cAAc,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,GAAG,CAAC,QAAQ,EAAE,CAAC,QAAQ,IAAI,CAAC,OAAO,IAAI,CAAC,SAAS,QAAQ,CAAC,MAAM,IAAI,CAAC,QAAQ,CAAC,CAAC,oBAAK,CAAC,IAAI,CAAC,kBAAG,CAAC,YAAY,IAAI,CAAC,WAAW,IAAI,CAAC,MAAM,IAAI,CAAC,oBAAK,CAAC,sBAAO,CAAC,iBAAiB,OAAO,CAAC,QAAQ,EAAE,CAAC,OAAO,IAAI,CAAC,MAAM,IAAI,CAAC,QAAQ,CAAC,CAAC,oBAAK,CAAC,OAAO,CAAC,uBAAQ,CAAC,QAAQ,IAAI,CAAC,GAAG,CAAC,GAAG,CAAC,oBAAK,CAAC,OAAO,CAAC,QAAQ,CAAC,iBAAE,CAAC,MAAM,OAAO,CAAC,YAAY,IAAI,CAAC,UAAU,GAAG,CAAC,YAAY,GAAG,CAAC,oBAAK,CAAC,OAAO,CAAC,QAAQ,CAAC,iBAAE,CAAC,MAAM,IAAI,CAAC,YAAY,IAAI,CAAC,UAAU,IAAI,CAAC,YAAY,GAAG,CAAC,oBAAK,CAAC,OAAO,CAAC,QAAQ,CAAC,iBAAE,CAAC,MAAM,IAAI,CAAC,YAAY,IAAI,CAAC,UAAU,GAAG,CAAC,YAAY,GAAG,CAAC,OAAO,CAAC,CAAC,oBAAK,CAAC,OAAO,CAAC,sBAAO,CAAC,OAAO,CAAC,CAAC,IAAI,CAAC,oBAAK,CAAC,OAAO,CAAC,OAAO,CAAC,mBAAI,CAAC,QAAQ,CAAC,CAAC,GAAG,CAAC,oBAAK,CAAC,OAAO,CAAC,OAAO,CAAC,IAAI,CAAC,gBAAC,CAAC,MAAM,IAAI,CAAC,gBAAgB,IAAI,CAAC,oBAAK,CAAC,OAAO,CAAC,OAAO,CAAC,IAAI,CAAC,CAAC,CAAC,gBAAC,CAAC,MAAM,IAAI,CAAC"}'
};
var ProductCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$7);
  return `<div class="${"card svelte-1rocsq8"}"><div class="${"top svelte-1rocsq8"}"><img src="${"./assets/imgs/shoe.png"}" alt="${"Shoe"}" class="${"svelte-1rocsq8"}"></div>
  <div class="${"bottom svelte-1rocsq8"}"><div class="${"details svelte-1rocsq8"}"><h1 class="${"svelte-1rocsq8"}">Nike Pro Elite</h1>
      <h3 class="${"svelte-1rocsq8"}">Running Shoe Pro</h3>
      <h6 class="${"svelte-1rocsq8"}">$200</h6></div>
    <div class="${"action svelte-1rocsq8"}"><span class="${"buy svelte-1rocsq8"}"><a href="${""}" class="${"svelte-1rocsq8"}"><i class="${"icon-buy svelte-1rocsq8"}"></i> Buy Now</a></span>
      <span class="${"cart svelte-1rocsq8"}"><a href="${""}" class="${"svelte-1rocsq8"}"><i class="${"icon-cart svelte-1rocsq8"}"></i>Add to cart</a></span></div></div>
</div>`;
});
...
var css$6 = {
  code: "a.svelte-ejpgfi{background:#4ebcd4;border:none;border-radius:20px;color:#f4f4f4;display:block;font-size:1.2em;padding:1em 2em;text-decoration:none;width:-webkit-fit-content;width:-moz-fit-content;width:fit-content}",
  map: '{"version":3,"file":"ATag.svelte","sources":["ATag.svelte"],"sourcesContent":["<script>\\r\\n  export let text, link;\\r\\n<\/script>\\r\\n\\r\\n<a href={link}>{text}</a>\\r\\n\\r\\n<style>a{background:#4ebcd4;border:none;border-radius:20px;color:#f4f4f4;display:block;font-size:1.2em;padding:1em 2em;text-decoration:none;width:-webkit-fit-content;width:-moz-fit-content;width:fit-content}</style>\\r\\n"],"names":[],"mappings":"AAMO,eAAC,CAAC,WAAW,OAAO,CAAC,OAAO,IAAI,CAAC,cAAc,IAAI,CAAC,MAAM,OAAO,CAAC,QAAQ,KAAK,CAAC,UAAU,KAAK,CAAC,QAAQ,GAAG,CAAC,GAAG,CAAC,gBAAgB,IAAI,CAAC,MAAM,mBAAmB,CAAC,MAAM,gBAAgB,CAAC,MAAM,WAAW,CAAC"}'
};
var ATag = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { text } = $$props, { link } = $$props;
  if ($$props.text === void 0 && $$bindings.text && text !== void 0)
    $$bindings.text(text);
  if ($$props.link === void 0 && $$bindings.link && link !== void 0)
    $$bindings.link(link);
  $$result.css.add(css$6);
  return `<a${add_attribute("href", link, 0)} class="${"svelte-ejpgfi"}">${escape2(text)}</a>`;
});
var css$5 = {
  code: ".no-data.svelte-65trbo.svelte-65trbo{background:#ff4500;border-radius:2px;padding:.2em}table.svelte-65trbo.svelte-65trbo{padding:.5em;row-gap:10px;width:100%}table.svelte-65trbo thead.svelte-65trbo{border:2px solid #ff4500;font-size:1.3em;font-weight:700;padding:.5em;text-align:center}table.svelte-65trbo tr.svelte-65trbo{border:1px solid #ff4500;font-size:3em;margin:.5em}table.svelte-65trbo tr td.svelte-65trbo,table.svelte-65trbo tr th.svelte-65trbo{border:1px solid #ff4500;font-size:.3em;margin:.5em}table.svelte-65trbo tr td.svelte-65trbo{padding:.8em 1em}table.svelte-65trbo tr.svelte-65trbo:last-child{font-size:.6em}",
  map: '{"version":3,"file":"index.svelte","sources":["index.svelte"],"sourcesContent":["<script>\\r\\n  import { session } from \\"$app/stores\\";\\r\\n  import ATag from \\"$lib/Buttons/ATag.svelte\\";\\r\\n  import supabase from \\"$lib/db\\";\\r\\n\\r\\n  const user = supabase.auth.user();\\r\\n<\/script>\\r\\n\\r\\n<svelte:head>\\r\\n  <title>Profile</title>\\r\\n</svelte:head>\\r\\n\\r\\n<h1>Profile</h1>\\r\\n{#if $session === null}\\r\\n  <h6>Please <a href=\\"/signin\\">Sign In</a> to view your profile.</h6>\\r\\n{:else}\\r\\n  <h3>Hello,</h3>\\r\\n  {#if user != null}\\r\\n    {#if user.user_metadata.name}\\r\\n      <h3>{user.user_metadata.name}</h3>\\r\\n    {:else}\\r\\n      {user.email}\\r\\n    {/if}\\r\\n    <table>\\r\\n      <thead>User data</thead>\\r\\n      {#if user.user_metadata != null}\\r\\n        {#if user.user_metadata.name != null}\\r\\n          <tr><th>Full Name:</th> <td>{user.user_metadata.name}</td></tr>\\r\\n        {:else}\\r\\n          <tr\\r\\n            ><th>Full Name:</th>\\r\\n            <td class=\\"no-data\\">No User Data Found.</td></tr\\r\\n          >\\r\\n        {/if}\\r\\n        {#if user.user_metadata.dob != null}\\r\\n          <tr><th>Date of Birth:</th> <td>{user.user_metadata.dob}</td></tr>\\r\\n        {:else}\\r\\n          <tr\\r\\n            ><th>Date of Birth:</th>\\r\\n            <td class=\\"no-data\\">No User Data Found.</td></tr\\r\\n          >\\r\\n        {/if}\\r\\n        {#if user.user_metadata.mob != null}\\r\\n          <tr><th>Mobile Number:</th> <td>{user.user_metadata.mob}</td></tr>\\r\\n        {:else}\\r\\n          <tr\\r\\n            ><th>Mobile Number:</th>\\r\\n            <td class=\\"no-data\\">No User Data Found.</td></tr\\r\\n          >\\r\\n        {/if}\\r\\n      {/if}\\r\\n\\r\\n      <tr>Last Updated: {user.updated_at.slice(0, 10)}</tr>\\r\\n    </table>\\r\\n    <ATag link=\\"/profile/update\\" text=\\"Update Profile\\" />\\r\\n    <!-- <pre>\\r\\n        {JSON.stringify(user, null, 2)}\\r\\n      </pre> -->\\r\\n  {:else}\\r\\n    Loading...\\r\\n  {/if}\\r\\n{/if}\\r\\n\\r\\n<style lang=\\"scss\\">.no-data{background:#ff4500;border-radius:2px;padding:.2em}table{padding:.5em;row-gap:10px;width:100%}table thead{border:2px solid #ff4500;font-size:1.3em;font-weight:700;padding:.5em;text-align:center}table tr{border:1px solid #ff4500;font-size:3em;margin:.5em}table tr td,table tr th{border:1px solid #ff4500;font-size:.3em;margin:.5em}table tr td{padding:.8em 1em}table tr:last-child{font-size:.6em}</style>\\r\\n"],"names":[],"mappings":"AA+DmB,oCAAQ,CAAC,WAAW,OAAO,CAAC,cAAc,GAAG,CAAC,QAAQ,IAAI,CAAC,iCAAK,CAAC,QAAQ,IAAI,CAAC,QAAQ,IAAI,CAAC,MAAM,IAAI,CAAC,mBAAK,CAAC,mBAAK,CAAC,OAAO,GAAG,CAAC,KAAK,CAAC,OAAO,CAAC,UAAU,KAAK,CAAC,YAAY,GAAG,CAAC,QAAQ,IAAI,CAAC,WAAW,MAAM,CAAC,mBAAK,CAAC,gBAAE,CAAC,OAAO,GAAG,CAAC,KAAK,CAAC,OAAO,CAAC,UAAU,GAAG,CAAC,OAAO,IAAI,CAAC,mBAAK,CAAC,EAAE,CAAC,gBAAE,CAAC,mBAAK,CAAC,EAAE,CAAC,gBAAE,CAAC,OAAO,GAAG,CAAC,KAAK,CAAC,OAAO,CAAC,UAAU,IAAI,CAAC,OAAO,IAAI,CAAC,mBAAK,CAAC,EAAE,CAAC,gBAAE,CAAC,QAAQ,IAAI,CAAC,GAAG,CAAC,mBAAK,CAAC,gBAAE,WAAW,CAAC,UAAU,IAAI,CAAC"}'
};
...
<h1>Profile</h1>
${$session === null ? `<h6>Please <a href="${"/signin"}">Sign In</a> to view your profile.</h6>` : `<h3>Hello,</h3>
  ${user != null ? `${user.user_metadata.name ? `<h3>${escape2(user.user_metadata.name)}</h3>` : `${escape2(user.email)}`}
    <table class="${"svelte-65trbo"}"><thead class="${"svelte-65trbo"}">User data</thead>
      ${user.user_metadata != null ? `${user.user_metadata.name != null ? `<tr class="${"svelte-65trbo"}"><th class="${"svelte-65trbo"}">Full Name:</th> <td class="${"svelte-65trbo"}">${escape2(user.user_metadata.name)}</td></tr>` : `<tr class="${"svelte-65trbo"}"><th class="${"svelte-65trbo"}">Full Name:</th>
            <td class="${"no-data svelte-65trbo"}">No User Data Found.</td></tr>`}
        ${user.user_metadata.dob != null ? `<tr class="${"svelte-65trbo"}"><th class="${"svelte-65trbo"}">Date of Birth:</th> <td class="${"svelte-65trbo"}">${escape2(user.user_metadata.dob)}</td></tr>` : `<tr class="${"svelte-65trbo"}"><th class="${"svelte-65trbo"}">Date of Birth:</th>
            <td class="${"no-data svelte-65trbo"}">No User Data Found.</td></tr>`}
        ${user.user_metadata.mob != null ? `<tr class="${"svelte-65trbo"}"><th class="${"svelte-65trbo"}">Mobile Number:</th> <td class="${"svelte-65trbo"}">${escape2(user.user_metadata.mob)}</td></tr>` : `<tr class="${"svelte-65trbo"}"><th class="${"svelte-65trbo"}">Mobile Number:</th>
            <td class="${"no-data svelte-65trbo"}">No User Data Found.</td></tr>`}` : ``}

      <tr class="${"svelte-65trbo"}">Last Updated: ${escape2(user.updated_at.slice(0, 10))}</tr></table>
    ${validate_component(ATag, "ATag").$$render($$result, {
    link: "/profile/update",
    text: "Update Profile"
  }, {}, {})}
    ` : `Loading...`}`}`;
...
var css$4 = {
  code: "button.svelte-10s473z{background:#4ebcd4;border:none;border-radius:20px;color:#f4f4f4;display:block;font-size:1.2em;margin:0 auto;padding:1em 2em;width:100%}",
  map: '{"version":3,"file":"Primary.svelte","sources":["Primary.svelte"],"sourcesContent":["<script>\\r\\n  export let text;\\r\\n<\/script>\\r\\n\\r\\n<button {...$$restProps}>\\r\\n  {text}\\r\\n</button>\\r\\n\\r\\n<style>button{background:#4ebcd4;border:none;border-radius:20px;color:#f4f4f4;display:block;font-size:1.2em;margin:0 auto;padding:1em 2em;width:100%}</style>\\r\\n"],"names":[],"mappings":"AAQO,qBAAM,CAAC,WAAW,OAAO,CAAC,OAAO,IAAI,CAAC,cAAc,IAAI,CAAC,MAAM,OAAO,CAAC,QAAQ,KAAK,CAAC,UAAU,KAAK,CAAC,OAAO,CAAC,CAAC,IAAI,CAAC,QAAQ,GAAG,CAAC,GAAG,CAAC,MAAM,IAAI,CAAC"}'
};
var Primary = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $$restProps = compute_rest_props($$props, ["text"]);
  let { text } = $$props;
  if ($$props.text === void 0 && $$bindings.text && text !== void 0)
    $$bindings.text(text);
  $$result.css.add(css$4);
  return `<button${spread([$$restProps], "svelte-10s473z")}>${escape2(text)}
</button>`;
});
var css$3 = {
  code: ".card.svelte-sb741m.svelte-sb741m{-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);background:hsla(36,53%,88%,.4);border-radius:20px;margin-top:4em;padding:2em 1.3em}h3.svelte-sb741m.svelte-sb741m{font-size:2em;text-shadow:2px 2px #b3b3b3}.footerText.svelte-sb741m.svelte-sb741m{padding:2em 1em;width:100%}.footerText.svelte-sb741m p.svelte-sb741m{display:inline}.footerText.svelte-sb741m a.svelte-sb741m,.footerText.svelte-sb741m p.svelte-sb741m{font-size:.8em}@media(min-width:800px){.card.svelte-sb741m.svelte-sb741m{float:right;min-width:25em}}",
  map: '{"version":3,"file":"FormCard.svelte","sources":["FormCard.svelte"],"sourcesContent":["<script>\\r\\n  export let heading, footerText, footerLink, footerLinkText;\\r\\n  export let handleAction;\\r\\n<\/script>\\r\\n\\r\\n<div class=\\"card\\">\\r\\n  <h3>{heading}</h3>\\r\\n  <form on:submit|preventDefault={handleAction} method=\\"post\\">\\r\\n    <slot />\\r\\n  </form>\\r\\n  <div class=\\"footerText\\">\\r\\n    {#if footerText || footerLinkText}\\r\\n      <p>{footerText}</p>\\r\\n      <a href={footerLink}>{footerLinkText}</a>\\r\\n    {/if}\\r\\n  </div>\\r\\n</div>\\r\\n\\r\\n<style lang=\\"scss\\">.card{-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);background:hsla(36,53%,88%,.4);border-radius:20px;margin-top:4em;padding:2em 1.3em}h3{font-size:2em;text-shadow:2px 2px #b3b3b3}.footerText{padding:2em 1em;width:100%}.footerText p{display:inline}.footerText a,.footerText p{font-size:.8em}@media (min-width:800px){.card{float:right;min-width:25em}}</style>\\r\\n"],"names":[],"mappings":"AAkBmB,iCAAK,CAAC,wBAAwB,KAAK,IAAI,CAAC,CAAC,gBAAgB,KAAK,IAAI,CAAC,CAAC,WAAW,KAAK,EAAE,CAAC,GAAG,CAAC,GAAG,CAAC,EAAE,CAAC,CAAC,cAAc,IAAI,CAAC,WAAW,GAAG,CAAC,QAAQ,GAAG,CAAC,KAAK,CAAC,8BAAE,CAAC,UAAU,GAAG,CAAC,YAAY,GAAG,CAAC,GAAG,CAAC,OAAO,CAAC,uCAAW,CAAC,QAAQ,GAAG,CAAC,GAAG,CAAC,MAAM,IAAI,CAAC,yBAAW,CAAC,eAAC,CAAC,QAAQ,MAAM,CAAC,yBAAW,CAAC,eAAC,CAAC,yBAAW,CAAC,eAAC,CAAC,UAAU,IAAI,CAAC,MAAM,AAAC,WAAW,KAAK,CAAC,CAAC,iCAAK,CAAC,MAAM,KAAK,CAAC,UAAU,IAAI,CAAC,CAAC"}'
};
var FormCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { heading } = $$props, { footerText } = $$props, { footerLink } = $$props, { footerLinkText } = $$props;
  let { handleAction } = $$props;
  if ($$props.heading === void 0 && $$bindings.heading && heading !== void 0)
    $$bindings.heading(heading);
  if ($$props.footerText === void 0 && $$bindings.footerText && footerText !== void 0)
    $$bindings.footerText(footerText);
  if ($$props.footerLink === void 0 && $$bindings.footerLink && footerLink !== void 0)
    $$bindings.footerLink(footerLink);
  if ($$props.footerLinkText === void 0 && $$bindings.footerLinkText && footerLinkText !== void 0)
    $$bindings.footerLinkText(footerLinkText);
  if ($$props.handleAction === void 0 && $$bindings.handleAction && handleAction !== void 0)
    $$bindings.handleAction(handleAction);
  $$result.css.add(css$3);
  return `<div class="${"card svelte-sb741m"}"><h3 class="${"svelte-sb741m"}">${escape2(heading)}</h3>
  <form method="${"post"}">${slots.default ? slots.default({}) : ``}</form>
  <div class="${"footerText svelte-sb741m"}">${footerText || footerLinkText ? `<p class="${"svelte-sb741m"}">${escape2(footerText)}</p>
      <a${add_attribute("href", footerLink, 0)} class="${"svelte-sb741m"}">${escape2(footerLinkText)}</a>` : ``}</div>
</div>`;
});
var css$2 = {
  code: "div.svelte-16z334y.svelte-16z334y{position:relative}label.svelte-16z334y.svelte-16z334y{background:#bbb;border-top-left-radius:1em;border-top-right-radius:1em;font-size:.7em;font-weight:700;margin:-10.4em .5em;padding:.7em 1em;position:absolute;z-index:-1}input.svelte-16z334y.svelte-16z334y{border:1.6px solid #bbb;border-radius:10px;display:block;font-size:1.2em;margin:1.5em auto;padding:1em 1em 1em 2px;width:-webkit-fill-available;width:-moz-available}input.svelte-16z334y.svelte-16z334y:focus{outline:none}input.svelte-16z334y:focus+label.svelte-16z334y{background:#646464;color:#eee}input.svelte-16z334y:valid+label.svelte-16z334y{background:#48bb44;color:#eee}input.svelte-16z334y.svelte-16z334y:valid{border:1.6px solid #48bb44}input[type=date].svelte-16z334y.svelte-16z334y{margin:2em auto}",
  map: '{"version":3,"file":"TextField.svelte","sources":["TextField.svelte"],"sourcesContent":["<script>\\r\\n  export let labelText, id, type, value;\\r\\n  function typeAction(node) {\\r\\n    node.type = type;\\r\\n  }\\r\\n<\/script>\\r\\n\\r\\n<div>\\r\\n  <input {id} {...$$restProps} bind:value use:typeAction />\\r\\n  <label for={id}>{labelText}</label>\\r\\n</div>\\r\\n\\r\\n<style lang=\\"scss\\">div{position:relative}label{background:#bbb;border-top-left-radius:1em;border-top-right-radius:1em;font-size:.7em;font-weight:700;margin:-10.4em .5em;padding:.7em 1em;position:absolute;z-index:-1}input{border:1.6px solid #bbb;border-radius:10px;display:block;font-size:1.2em;margin:1.5em auto;padding:1em 1em 1em 2px;width:-webkit-fill-available;width:-moz-available}input:focus{outline:none}input:focus+label{background:#646464;color:#eee}input:valid+label{background:#48bb44;color:#eee}input:valid{border:1.6px solid #48bb44}input[type=date]{margin:2em auto}</style>\\r\\n"],"names":[],"mappings":"AAYmB,iCAAG,CAAC,SAAS,QAAQ,CAAC,mCAAK,CAAC,WAAW,IAAI,CAAC,uBAAuB,GAAG,CAAC,wBAAwB,GAAG,CAAC,UAAU,IAAI,CAAC,YAAY,GAAG,CAAC,OAAO,OAAO,CAAC,IAAI,CAAC,QAAQ,IAAI,CAAC,GAAG,CAAC,SAAS,QAAQ,CAAC,QAAQ,EAAE,CAAC,mCAAK,CAAC,OAAO,KAAK,CAAC,KAAK,CAAC,IAAI,CAAC,cAAc,IAAI,CAAC,QAAQ,KAAK,CAAC,UAAU,KAAK,CAAC,OAAO,KAAK,CAAC,IAAI,CAAC,QAAQ,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,MAAM,sBAAsB,CAAC,MAAM,cAAc,CAAC,mCAAK,MAAM,CAAC,QAAQ,IAAI,CAAC,oBAAK,MAAM,CAAC,oBAAK,CAAC,WAAW,OAAO,CAAC,MAAM,IAAI,CAAC,oBAAK,MAAM,CAAC,oBAAK,CAAC,WAAW,OAAO,CAAC,MAAM,IAAI,CAAC,mCAAK,MAAM,CAAC,OAAO,KAAK,CAAC,KAAK,CAAC,OAAO,CAAC,KAAK,CAAC,IAAI,CAAC,IAAI,+BAAC,CAAC,OAAO,GAAG,CAAC,IAAI,CAAC"}'
};
var TextField = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $$restProps = compute_rest_props($$props, ["labelText", "id", "type", "value"]);
  let { labelText } = $$props, { id } = $$props, { type } = $$props, { value } = $$props;
  ...
  return `<div class="${"svelte-16z334y"}"><input${spread([{ id: escape2(id) }, $$restProps], "svelte-16z334y")}${add_attribute("value", value, 1)}>
  <label${add_attribute("for", id, 0)} class="${"svelte-16z334y"}">${escape2(labelText)}</label>
</div>`;
});
function guard(name) {
  return () => {
...
var goto = guard("goto");
var Update = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const handleUpdate = async () => {
    await supabase.auth.update({
      data: { name: username, dob, mob: mobno }
    });
    alert("Profile has successfully updated.");
    goto("/profile");
  };
  if ($$props.today === void 0 && $$bindings.today && today !== void 0)
    $$bindings.today(today);
  let $$settled;
  let $$rendered;
  do {
    $$settled = true;
    $$rendered = `${$$result.head += `${$$result.title = `<title>Profile</title>`, ""}`, ""}

<h1>Update Profile</h1>
${validate_component(ATag, "ATag").$$render($$result, { link: "/profile", text: "Profile" }, {}, {})}
${validate_component(FormCard, "FormCard").$$render($$result, {
      handleAction: handleUpdate,
      heading: "Update Your Profile"
    }, {}, {
      default: () => `${validate_component(TextField, "TextField").$$render($$result, {
        type: "text",
        labelText: "Name",
        id: "fullName",
  ...
  ${validate_component(Primary, "Primary").$$render($$result, { text: "Update" }, {}, {})}`
    })}`;
  } while (!$$settled);
  return $$rendered;
});
...
var Icon = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<svg${add_attribute("class", $$props.class, 0)}${add_attribute("focusable", focusable, 0)}${add_attribute("width", width, 0)}${add_attribute("height", height, 0)} viewBox="${"0 0 " + escape2(displayIcon.box1) + " " + escape2(displayIcon.box2)}">${displayIcon.svg}</svg>`;
});
var css$1 = {
  code: 'section.svelte-gzpl9i:before{background:#75d0d6;-webkit-clip-path:ellipse(90% 60% at 18% 24%);clip-path:ellipse(90% 60% at 18% 24%);content:"";height:45em;left:0;overflow:hidden;position:absolute;top:0;width:100%;z-index:-3}.bannerimg.svelte-gzpl9i{float:left;left:7%;position:absolute;top:25%}@media(max-width:970px){.bannerimg.svelte-gzpl9i{display:none}}',
  map: '{"version":3,"file":"signin.svelte","sources":["signin.svelte"],"sourcesContent":["<script>\\r\\n  import Primary from \\"$lib/Buttons/Primary.svelte\\";\\r\\n  import FormCard from \\"$lib/FormCard/FormCard.svelte\\";\\r\\n  import Icon from \\"$lib/IconsSvgs/Icon.svelte\\";\\r\\n  import TextField from \\"$lib/Inputs/TextField.svelte\\";\\r\\n  import supabase from \\"$lib/db\\";\\r\\n  import { session } from \\"$app/stores\\";\\r\\n  import { goto } from \\"$app/navigation\\";\\r\\n\\r\\n  let userEmail, userPassword;\\r\\n\\r\\n  const handleSignin = async () => {\\r\\n    let {\\r\\n      user,\\r\\n      session: supaSession,\\r\\n      error,\\r\\n    } = await supabase.auth.signIn({\\r\\n      email: userEmail,\\r\\n      password: userPassword,\\r\\n    });\\r\\n    $session = supaSession;\\r\\n    goto(\\"/\\");\\r\\n    console.log(user, session, error);\\r\\n  };\\r\\n<\/script>\\r\\n\\r\\n<svelte:head>\\r\\n  <title>Sign In</title>\\r\\n</svelte:head>\\r\\n\\r\\n{#if $session === null}\\r\\n  <section>\\r\\n    <div class=\\"bannerimg\\">\\r\\n      <Icon class=\\"signupBanner\\" name=\\"signin\\" width=\\"400px\\" height=\\"400px\\" />\\r\\n    </div>\\r\\n    <FormCard\\r\\n      heading=\\"Sign In\\"\\r\\n      footerText=\\"Not registered yet?\\"\\r\\n      footerLinkText=\\"Sign Up\\"\\r\\n      footerLink=\\"/signup\\"\\r\\n      handleAction={handleSignin}\\r\\n    >\\r\\n      <TextField\\r\\n        required\\r\\n        bind:value={userEmail}\\r\\n        type=\\"email\\"\\r\\n        id=\\"email\\"\\r\\n        labelText=\\"Email\\"\\r\\n      />\\r\\n      <TextField\\r\\n        required\\r\\n        bind:value={userPassword}\\r\\n        type=\\"password\\"\\r\\n        id=\\"password\\"\\r\\n        labelText=\\"Password\\"\\r\\n      />\\r\\n      <Primary type=\\"submit\\" text=\\"Sign In\\" />\\r\\n    </FormCard>\\r\\n  </section>\\r\\n{:else}\\r\\n  <h6>View <a href=\\"/profile\\">profile</a>.</h6>\\r\\n{/if}\\r\\n\\r\\n<style lang=\\"scss\\">section:before{background:#75d0d6;-webkit-clip-path:ellipse(90% 60% at 18% 24%);clip-path:ellipse(90% 60% at 18% 24%);content:\\"\\";height:45em;left:0;overflow:hidden;position:absolute;top:0;width:100%;z-index:-3}.bannerimg{float:left;left:7%;position:absolute;top:25%}@media (max-width:970px){.bannerimg{display:none}}</style>\\r\\n"],"names":[],"mappings":"AA+DmB,qBAAO,OAAO,CAAC,WAAW,OAAO,CAAC,kBAAkB,QAAQ,GAAG,CAAC,GAAG,CAAC,EAAE,CAAC,GAAG,CAAC,GAAG,CAAC,CAAC,UAAU,QAAQ,GAAG,CAAC,GAAG,CAAC,EAAE,CAAC,GAAG,CAAC,GAAG,CAAC,CAAC,QAAQ,EAAE,CAAC,OAAO,IAAI,CAAC,KAAK,CAAC,CAAC,SAAS,MAAM,CAAC,SAAS,QAAQ,CAAC,IAAI,CAAC,CAAC,MAAM,IAAI,CAAC,QAAQ,EAAE,CAAC,wBAAU,CAAC,MAAM,IAAI,CAAC,KAAK,EAAE,CAAC,SAAS,QAAQ,CAAC,IAAI,GAAG,CAAC,MAAM,AAAC,WAAW,KAAK,CAAC,CAAC,wBAAU,CAAC,QAAQ,IAAI,CAAC,CAAC"}'
};
var Signin = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let userEmail, userPassword;
  const handleSignin = async () => {
    let { user, session: supaSession, error: error22 } = await supabase.auth.signIn({ email: userEmail, password: userPassword });
    set_store_value(session, $session = supaSession, $session);
    goto("/");
    console.log(user, session, error22);
  };
  ...
  do {
    $$settled = true;
    $$rendered = `${$$result.head += `${$$result.title = `<title>Sign In</title>`, ""}`, ""}

${$session === null ? `<section class="${"svelte-gzpl9i"}"><div class="${"bannerimg svelte-gzpl9i"}">${validate_component(Icon, "Icon").$$render($$result, {
      class: "signupBanner",
      name: "signin",
      width: "400px",
      height: "400px"
    ...
    ${validate_component(FormCard, "FormCard").$$render($$result, {
      ...
      ${validate_component(Primary, "Primary").$$render($$result, { type: "submit", text: "Sign In" }, {}, {})}`
    })}</section>` : `<h6>View <a href="${"/profile"}">profile</a>.</h6>`}`;
  } while (!$$settled);
  $$unsubscribe_session();
  return $$rendered;
});
...
var Signup = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let userEmail, userPassword;
  const handleSignup = async () => {
    let { user, session: supaSession, error: error22 } = await supabase.auth.signUp({ email: userEmail, password: userPassword });
    set_store_value(session, $session = supaSession, $session);
    goto("/");
    console.log(user, session, error22);
  };
  ...
  do {
    $$settled = true;
    $$rendered = `${$$result.head += `${$$result.title = `<title>Sign Up</title>`, ""}`, ""}
...
${$session === null ? `<section class="${"svelte-gzpl9i"}"><div class="${"bannerimg svelte-gzpl9i"}">${validate_component(Icon, "Icon").$$render($$result, {
    ...
    ${validate_component(FormCard, "FormCard").$$render($$result, {
      ...
      ${validate_component(Primary, "Primary").$$render($$result, { type: "submit", text: "Sign Up" }, {}, {})}`
    })}</section>` : `<h6>View <a href="${"/profile"}">profile</a></h6>`}`;
  } while (!$$settled);
  $$unsubscribe_session();
  return $$rendered;
